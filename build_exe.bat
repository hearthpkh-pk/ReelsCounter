...
echo ======== 🔧 Starting ReelsCounterPro Build ========
...
copy "fix_browser_issue.bat" "dist\ReelsCounterPro\"
copy "fix_defender_exclusions.bat" "dist\ReelsCounterPro\"
copy "add_defender_exclusion.bat" "dist\ReelsCounterPro\"
copy "clear_cache.bat" "dist\ReelsCounterPro\" 2>nul
copy "BROWSER_ISSUE_FIX.md" "dist\ReelsCounterPro\"

REM Copy docs folder
xcopy "docs" "dist\ReelsCounterPro\docs\" /E /I /Y 2>nul

echo ✅ DONE! Build finished.
echo 📦 EXE location: dist\ReelsCounterPro\ReelsCounterPro.exe
